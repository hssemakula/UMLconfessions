...
import com.example.hillary.umlconfessions.tools.Strings;
...
public class CommentsPageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        confessionsFramework = (Confessions) intent.getSerializableExtra(Strings.ADD_CONFESSIONS);
        ...
        DatabaseUsage.findUserInfo(DatabaseUsage.findCurrentUserInfo.findEmail().replace(".",",")).addListenerForSingleValueEvent(
                ...
                public void onDataChange(DataSnapshot dataSnapshot){
                    ...
                    if(userInfo.getActive() == true){
                        ...
                        DatabaseUsage.findConfession().child(confessionsFramework.getConfessionID()).child(Strings.KEY_FOR_COMMENTS_NUMBER).runTransaction(new Transaction.Handler() {
                            @Override
