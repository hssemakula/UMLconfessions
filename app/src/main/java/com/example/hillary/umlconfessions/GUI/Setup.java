...
public class Setup extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        FloatingActionButton f = (FloatingActionButton) rootView.findViewById(R.id.);
    ...
    private void startSetup(){
        confessionsRecyclerView = (RecyclerView) rootView.findViewById(R.id.);
    ...
    private void makeAdapter(){
        confessionsAdaper = new FirebaseRecyclerAdapter<Confessions, ConfessionsHolder>(
                Confessions.class, R.layout., ConfessionsHolder.class, DatabaseUsage.findConfession()){
    ...
    public static class ConfessionsHolder extends RecyclerView.ViewHolder {
        ...
        public ConfessionsHolder(View itemView) {
            ...
            Time_Text = (TextView) itemView.findViewById(R.id.);
            like_layout = (LinearLayout) itemView.findViewById(R.id.);
            comments_layout = (LinearLayout) itemView.findViewById(R.id.);
            like_Count_Text = (TextView) itemView.findViewById(R.id.);
            comments_Count_Text = (TextView) itemView.findViewById(R.id.);
            content_Text = (TextView) itemView.findViewById(R.id.);
