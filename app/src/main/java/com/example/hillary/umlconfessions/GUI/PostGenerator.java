...
public class PostGenerator extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        rootView = getActivity().getLayoutInflater().inflate(R.layout., null); //layout for creating a "confession"
        showConfession = (ImageView)rootView.findViewById(R.id.); //an imageview in creating a confession....maybe not necessary
        rootView.findViewById(R.id.).setOnClickListener(this);//the "send" imageview
    ...
    private void submitConfession(){
        ...
        DatabaseUsage.findUserInfo(DatabaseUsage.findCurrentUserInfo().findEmail_address().replace(".",",")).addListenerForSingleValueEvent(
                new ValueEventListener(){
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot){
                        ...
                        if(userInfo.getActive() == true){
                            ...
                            TextView confessDialog = (TextView) rootView.findViewById(R.id.);//layout attribute where the user types in his confession
    ...
    private void appendConfessionsFeed(String confessionsId){
        ...
        OnlineFunctionality.appendRecord(Strings_Reference.KEY_FOR_CONFESSIONS, confessionsId);
    }
}*/
